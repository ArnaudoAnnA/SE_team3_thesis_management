        ...
        <Form onSubmit={handleSubmit} >
            ...
            <div class="container" style={{marginBottom: "20px"}}>
                  ...
                  <article className="proposal-article" style={{maxWidth: "85vw", paddingLeft: "30px", paddingRight: "30px"}}>
                      ...
                      <input style={{ borderRadius: "6px" }} name="" class="form-control" placeholder="Thesis title" type="text" value={title} onChange={ev => setTitle(ev.target.value)} />
                    </div>
                    <div class="form-group input-group" style={{  marginBottom: "2px" }}>
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" style={{ marginRight:"1vw"}} width="16" height="16" fill="currentColor" class="bi bi-book-fill" viewBox="0 0 16 16">
                        <path d="M8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783z" />
                          ...
                          <select class="form-control" style={{borderRadius: "6px"}} value={degree} onChange={ev => setDegree(ev.target.value)}>
                      ...
                      <input style={{ borderRadius: "6px" }} name="" class="form-control" placeholder="Required Knowledge" type="text" value={knowledge} onChange={ev => setKnowledge(ev.target.value)} />
                    </div>
                      <div class="form-group input-group" style={{ marginTop: '4px'}}>
                          <div class="input-group-prepend">
                        <svg xmlns="http://www.w3.org/2000/svg"  style={{ marginRight:"1vw"}} width="16" height="16" fill="currentColor" class="bi bi-arrow-bar-up" viewBox="0 0 16 16">
                          ...
                          <select class="form-control" style={{borderRadius: "6px"}} value={level} onChange={ev => setLevel(ev.target.value)}>
                      ...
                      <div class="form-group input-group" style={{ marginTop: "2px", marginBottom: "2px", display: 'flex', alignItems: 'center' }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: "column", flex: 1 }}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" style={{ marginRight: "1vw" , marginTop: "2% "}} width="16" height="16" fill="currentColor" class="bi bi-file-word-fill" viewBox="0 0 16 16">
                          <path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zM5.485 4.879l1.036 4.144.997-3.655a.5.5 0 0 1 .964 0l.997 3.655 1.036-4.144a.5.5 0 0 1 .97.242l-1.5 6a.5.5 0 0 1-.967.01L8 7.402l-1.018 3.73a.5.5 0 0 1-.967-.01l-1.5-6a.5.5 0 1 1 .97-.242z" />
                        </svg>
                        <input onKeyDown={handleKeyDown} style={{ borderRadius: "3px", marginTop: "2px", marginBottom: "2px", borderWidth: "1px", flex: 1 }} type="text" class="form-control" placeholder="Keywords" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group input-group" style={{ marginTop: "4px", marginBottom: "2px" }}>
                      <div class="input-group-prepend">
                  ...
                  <div style={{display: "flex"}}>
                    ...
                    <div class="form-group input-group" style={{display: "flex", marginBottom: "2px", flexDirection: "column", flexWrap: "wrap"}}>
                      ...
                      <div class="form-group" style={{marginTop: "2vh", display: 'flex'}}>
                          <Button id="sendpb" style={{marginLeft: "auto", marginRight:"auto",  width: "150px", marginBottom: '10px'}} type="submit" class="btn btn-primary btn-block" onClick={handleSubmit}> Upload Proposal  </Button>
                      </div>     
