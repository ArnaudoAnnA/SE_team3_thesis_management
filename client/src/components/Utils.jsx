                ...
                <header sticky="top" expand="lg" className="whiteNavbar mb-3">
                    <div className='generalNavbar shadow'>
                        ...
                        <div className="links">
                                ...
                                {user.role == 'teacher' ? <Nav.Link as={Link} to={"/archive"} className="customLink" href='/archive' onClick={() => {navigate('/archive'); window.location.reload(true)}}>Archive</Nav.Link> : null}
                                {user.role == 'teacher' ? <Nav.Link as={Link} to={"/Professor_STRlist"} className="customLink" href='/Professor_STRlist' onClick={() => {navigate('/Professor_STRlist'); window.location.reload(true)}}>Thesis Requests</Nav.Link> : null}
    ...
    return <>
        <div className={`sidebar ${props.isOpen && "open"}`}>
            ...
            <div className="mt-5">
                ...
                {props.user.role == 'teacher' ? <Nav.Link as={Link} to={"/archive"} className="customSidebarLink" href='/archive' onClick={() => {navigate('/archive'); window.location.reload(true); props.closeSidebar()}}>Archive</Nav.Link> : null}
                {props.user.role == 'teacher' ? <Nav.Link as={Link} to={"/Professor_STRlist"} className="customSidebarLink" href='/Professor_STRlist' onClick={() => {navigate('/Professor_STRlist'); window.location.reload(true); props.closeSidebar()}}>Thesis Requests</Nav.Link> : null}
