    ...
    switch(props.DBfield)
    {
        case "expirationDate":
            return <>
                        ...
                        <Col><Form.Label>To:</Form.Label><Form.Control defaultValue={props.filters.expirationDate.to} id={"expirationDateFrom"} type="date" onChange={(event) => onChangeFiltersForm(event)}/></Col>
                </>;
        default:
