    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                ...
                {props.notification.applicationsFlag && <div className='d-flex justify-content-center'><br/><Link to={`/applications/`} className="btn blueButton" state={{nextpage: location.pathname}}> <span className='white'> Go to the pending applications &nbsp; </span> <i className="bi bi-search white"></i> </Link></div>}
